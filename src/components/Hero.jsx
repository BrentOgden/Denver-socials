        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="px-6 py-3 bg-[#8A3202] text-white font-semibold rounded animate-bounce-slow hover:bg-[#8A3202]/90" target="_blank"
            >
              Join Us on Meetup
            </a>
            <a
              href="https://www.eventbrite.com/o/denver-socials-94476587943"
              className="px-6 py-3 border-2 border-white text-white font-semibold  bg-black/20 rounded animate-bounce-slow hover:bg-white hover:text-gray-900" target="_blank"
            >
